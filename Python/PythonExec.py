...
def create_maven_artifact_badge_svg_file(data: dict):
  ...
  <!-- 顶部：Maven 标识 -->
  <ellipse  cx="400" cy="45" rx="70" ry="22"  fill="#ff4081"/>
  <text x="400" y="47" text-anchor="middle" font-family="Arial" font-size="12" fill="white" font-weight="bold">MavenArtifactBadge</text>
  <!-- 主体内容：垂直布局 -->
