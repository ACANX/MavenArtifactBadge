...
def create_maven_artifact_badge_svg_file(data: dict):
  ...
  <g transform="translate(15, 15)">
    ...
    <text x="0" y="80" font-family="Arial" font-size="11" fill="white">
      Latest Version: <tspan font-weight="bold">{latest_version}</tspan>
    </text>
    <!-- 统计信息 -->
    <text x="0" y="100" font-family="Arial" font-size="11" fill="white">
      Dependencies: <tspan font-weight="bold">{dependency_count}</tspan>
    </text>
    <text x="0" y="115" font-family="Arial" font-size="11" fill="white">
      References: <tspan font-weight="bold">{ref_count}</tspan>
    </text>
    <!-- 分类信息 -->
    <text x="0" y="135" font-family="Arial" font-size="11" fill="white">
      Categories: <tspan font-weight="bold">{categories_text}</tspan>
    </text>
  </g>
  <!-- 底部信息 -->
  <text x="10" y="145" font-family="Arial" font-size="9" fill="#d0d0d0">
    Generated by Maven Badge Generator
  </text>
</svg>"""
